...
public class ActiveRepairService implements IEndpointStateChangeSubscriber, IFailureDetectionEventListener
{
    ...
    RepairFuture submitArtificialRepairSession(RepairJobDesc desc)
    {
        ...
        Collection<Range<Token>> keyspaceLocalRange = StorageService.instance.getLocalRanges(desc.keyspace);
        neighbours.addAll(ActiveRepairService.getNeighbors(desc.keyspace, keyspaceLocalRange, desc.range, null, null));
     ...
     * @param keyspaceLocalRange local-range for given keyspaceName
     * @param toRepair token to repair
     * @param dataCenters the data centers to involve in the repair
     *
     * @return neighbors with whom we share the provided range
     */
    public static Set<InetAddress> getNeighbors(String keyspaceName, Collection<Range<Token>> keyspaceLocalRange, Range<Token> toRepair, Collection<String> dataCenters, Collection<String> hosts)
    {
        StorageService ss = StorageService.instance;
        Map<Range<Token>, List<InetAddress>> replicaSets = ss.getRangeToAddressMap(keyspaceName);
        Range<Token> rangeSuperSet = null;
        for (Range<Token> range : keyspaceLocalRange)
        {
