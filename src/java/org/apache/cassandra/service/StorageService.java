                                                ...
                                                final String... columnFamilies)
    {
        ...
        return new FutureTask<>(new WrappedRunnable()
        {
            protected void runMayThrow() throws Exception
            {
                ...
                Collection<Range<Token>> keyspaceLocalRange = getLocalRanges(keyspace);
                ...
                for (Range<Token> range : ranges)
                {
                    try
                    {
                        Set<InetAddress> neighbors = ActiveRepairService.getNeighbors(keyspace, keyspaceLocalRange, range, dataCenters, hosts);
